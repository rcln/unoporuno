...
class GoogleSearch(object):
    ...
    def _extract_description(self, result):
        ...
        #JGF: modificado el 13/oct/2012 siguiendo cambios de Google
        ...
        if not desc_div:
            ...
            return None
        #print 'DESC_DIV=', desc_div
        descripcion = ''.join(desc_div.findAll(text=True))
        return self._html_unescape(descripcion)

    # def _extract_description(self, result):
    # funciona a las 12:18
    #     desc_div = result.find('div', {'class': re.compile(r'\bs\b')})
    #     if not desc_div:
    #         self._maybe_raise(ParseError, "Description tag in Google search result was not found", result)
    #         return None
    ...
    #             #JGF
    #             print '**********'
    #             print 'xgoogle::search.py::GoogleSearch::extract_description::tag', t
    #             try:
    #                 if t.name == 'br': #JGF: break
    #                     desc_strs.append(' ')
    #             except AttributeError:
    #                 pass

    #             try:
    #                 print 'xgoogle::search.py::T_OUT=', t.string
    #                 desc_strs.append(t.string)
    #             except AttributeError:
    #                 desc_strs.append(t)

    #     looper(desc_div)
    #     looper(desc_div.find('span')) # BeautifulSoup does not self-close <wbr>
