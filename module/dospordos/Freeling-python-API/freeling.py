...
class analyzer(_object):
    ...
    def set_current_invoke_options(self, opt, check=True):
        return _freeling.analyzer_set_current_invoke_options(self, opt, check)

    def get_current_invoke_options(self):
    ...
    def analyze_as_document(self, text, parag=False):
        return _freeling.analyzer_analyze_as_document(self, text, parag)

    def flush_buffer(self, ls):
